...
from const_str import GssInfo, ChatGptInfo, EndPoint
...
#todo 各メソッドをまとめる
    ...
    async def process(self, query: str):
        ...
        if any(item == '該当なし' for item in stores_info):
            none_data = [[f'{query} にて調べましたが該当店舗はありませんでした。', self.fullCurrentDate, '', '', '']]
